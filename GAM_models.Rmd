...
# Refining the original models

This page basically contains an updated version of the original models. The main difference is that we got rid of `autocovariate models`, which showed a poor performance and seem to be little informative.
